...
<h2 align="center">网站后台管理<h3>
<ul>
  <li>文本编辑</li>
  <li>图库管理</li>
  <ul>
  	<li>1. 打开产品图库<a href="#browse"> 详细<a></li>
  	<li>2. 清空图库内容<a href="#clear"> 详细<a></li>
  	<li>3. 添加产品图片<a href="#addimg"> 详细<a></li>
  	<li>4. 查看效果<a href="#review"> 详细<a></li>
  </ul>
</ul> 
...
1. 打开产品图库
	点击<a href="./gallery/index.php">这里<a>查看产品图库。
...
<a name="clear"><br><pre>
2. 清空图库内容
	点击<a onClick="confirm()" href="#">这里<a>可以清空图库内容图片。
